...
ks.test(rel_data2$income, "pnorm", mean=mean_income_2, sd=sqrt(var_income_2))
# D = 0.15422, p-value = 0.02239; alternative hypothesis: two-sided
# p-value < 0.05 => reject the null hypothesis 
# => income does not have normal distribution
...
## NB: shapiro.test is more accurate than ks.test

ks.test(rel_data1$income, "pnorm", mean=mean_income_1, sd=sqrt(var_income_1))
# D = 0.14114, p-value = 0.08093
